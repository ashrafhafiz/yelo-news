{{-- This is another search-box other than the search-box livewire component --}}
{{-- Using AlpineJS --}}
<div id="search-box" x-data="{
    query: '{{ request('search', '') }}',
    updateSearch(){
        $dispatch('search', {search: this.query})
    }
     }">
    <div>
        ...
        <div class="flex items-center px-3 py-2 mb-3 bg-gray-100 w-52 rounded-2xl">
            ...
            <input x-model="query" x-on:keyup.enter='updateSearch'
        ...
        <x-button x-on:click="updateSearch">Search</x-button>
    </div>
</div>
